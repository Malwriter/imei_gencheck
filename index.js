...
const tacdbFilePath='./data/tacdb_consistent_sorted_clear.csv';
...
imei_gencheck.loadDB = (loaderCallback)=>{
    ...
    var parser = parse({delimiter: ','}, function (err, data) {
        ...
        (err, rez)=>{
            ...
            imei_gencheck.findTACinfo = (tacToFind, outerCallback) => {
                let foundTACs = [];
            ...
            imei_gencheck.findTACInfoByIMEI = (imei, outerCallback) => {
                ...
                recursiveTACSearch = function () {
                    ...
                    imei_gencheck.findTACinfo(tacToFind, function (iteration_foundTACs) {
                ...
                recursiveTACSearch(recursiveTACSearch);
            }

            imei_gencheck.randomTACInfoWithVendorName = function (name1, outerCallback) {
                ...
                let nonBlockingSearch = function (nonBlockingSearchCallBack) {
                    ...
                    if (curIndex < dblen) {
                        ...
                        if (foundTACs.length > 0) {
                            ...
                            outerCallback(foundTACs[chosenTACInfoID]);
                        } else {
                            outerCallback(null);
                        }
                    }
            ...
            imei_gencheck.randomTACInfoWithNames = (name1, name2, outerCallback) => {
            ...
            // todo:
            //imei_gencheck.findTACInfoByFields(fields, values, outerCallback){
            //
            //}
